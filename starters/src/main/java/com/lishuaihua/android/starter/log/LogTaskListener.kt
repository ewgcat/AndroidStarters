package com.lishuaihua.android.starter.log

import com.lishuaihua.android.starter.Constants
...
import com.lishuaihua.android.starter.task.TaskState
...
class LogTaskListener : TaskListener {
    ...
    companion object {
        private fun logTaskRuntimeInfoString(task: Task) {
            val taskRuntimeInfo = task.StartersRuntime.getTaskRuntimeInfo(task.id) ?: return
            ...
            addTaskInfoLineString(builder, Constants.IS_Starter, java.lang.String.valueOf(taskRuntimeInfo.isStarter), false)
            ...
            if (taskRuntimeInfo.isStarter) {
                d(Constants.StarterS_INFO_TAG, builder.toString())
            }
        }
